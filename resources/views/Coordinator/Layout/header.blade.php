...
<html lang="en">
  <head>
    ...
    <title>Coordinator - CareerIn </title>
  </head>
  <body>   
      ...
      <div class="container">
        <div class="main-header">
          <div class="header-left">
            <div class="header-logo"><a class="d-flex" href="/"><h3>CareerIn</h3></a></div><span class="btn btn-grey-small ml-10">Coordinator area</span>
          </div>
            ...
            @endphp
              <div class="member-login"><img alt="" src="{{asset($profile_link)}}">
                <div class="info-member"> <strong class="color-brand-1">
                  ...
                  <div class="dropdown"><a class="font-xs color-text-paragraph-2 icon-down" id="dropdownProfile" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static">Coordinator</a>
              ...
              <nav>
                <ul class="main-menu">
                    ...
                    @elseif(session()->get('page')=="profile")
                        ...
                        @endphp
                    @endif
                    <li> <a class="dashboard2 {{$dashboard}}" href="/corrdinator_dashboard"><img src="{{asset('employerassets/imgs/page/dashboard/dashboard.svg')}}" alt="jobBox"><span class="name">Dashboard</span></a>
                    </li>
                    ...
                    <li> <a class="dashboard2 {{$profiles}}" href="/coordinator-profile"><img src="{{asset('employerassets/imgs/page/dashboard/profiles.svg')}}" alt="jobBox"><span class="name">Account</span></a>
                    </li>
