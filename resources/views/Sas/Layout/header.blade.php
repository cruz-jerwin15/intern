      ...
      <div class="container">
        <div class="main-header">
          <div class="header-left">
            <div class="header-logo"><a class="d-flex" href="/"><h3>CareerIn</h3></a></div><span class="btn btn-grey-small ml-10">Sas area</span>
          </div>
            ...
            <div class="block-signin">
              ...
              <div class="member-login"><img alt="" src="{{asset('employerassets/imgs/page/dashboard/profile.png')}}">
                <div class="info-member"> <strong class="color-brand-1">
                  ...
                  <div class="dropdown"><a class="font-xs color-text-paragraph-2 icon-down" id="dropdownProfile" type="button" data-bs-toggle="dropdown" aria-expanded="false" data-bs-display="static">SAS</a>
